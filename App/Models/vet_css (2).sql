...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2017 at 02:13 AM
...
(3498, 'Paul', 'George', 'PolSci instructor'),
(3499, 'Peter', 'Parker', 'Bio instructor'),
(63038, 'James', 'LeBron', 'English instructo'),
(63039, 'John', 'Wall', 'Math instructor');
...
(1, 1, 1, 1, 63039, 3, 2, NULL, 1, 5, 1),
(2, 1, 2, 1, 3498, NULL, 1, NULL, NULL, NULL, 1),
(3, 1, 3, 1, 63038, NULL, 1, NULL, NULL, NULL, 3),
(4, 1, 1, 2, 63039, NULL, 2, NULL, NULL, NULL, 1),
(5, 1, 2, 2, 3498, NULL, 1, NULL, NULL, NULL, 1),
(6, 1, 3, 2, 63038, 1, 1, NULL, NULL, NULL, 3);
...
--
ALTER TABLE `meeting`
  ADD CONSTRAINT `SubjectClass` FOREIGN KEY (`subject_id`) REFERENCES `subject_class` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `room`
--
ALTER TABLE `room`
  ADD CONSTRAINT `RoomType` FOREIGN KEY (`type`) REFERENCES `room_type` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `subject_class`
--
ALTER TABLE `subject_class`
  ADD CONSTRAINT `instructor_id` FOREIGN KEY (`instructor_id`) REFERENCES `instructor` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `subject_id` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`),
  ADD CONSTRAINT `timetable_id` FOREIGN KEY (`timetable_id`) REFERENCES `timetable` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `trainee_group_id` FOREIGN KEY (`trainee_group_id`) REFERENCES `trainee_group` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
