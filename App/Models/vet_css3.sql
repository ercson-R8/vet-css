...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2017 at 06:57 AM
...
INSERT INTO `subject_class` (`id`, `timetable_id`, `subject_id`, `trainee_group_id`, `instructor_id`, `room_id`, `meeting_time_id`, `preferred_start_period`, `preferred_end_period`, `preferred_number_days`) VALUES
(1, 1, 1, 1, 1, NULL, NULL, 1, 5, 1),
(2, 1, 2, 1, 2, NULL, NULL, 1, 5, 1),
(3, 1, 3, 1, 3, NULL, NULL, 1, 5, 3),
(4, 1, 1, 2, 1, NULL, NULL, 1, 5, 1),
(5, 1, 2, 2, 2, NULL, NULL, 1, 5, 1),
(6, 1, 3, 2, 3, NULL, NULL, 1, 5, 3);
...
ALTER TABLE `subject_class`
  ...
  ADD KEY `trainee_group_id_2` (`trainee_group_id`),
...
--
ALTER TABLE `subject_class`
  ADD CONSTRAINT `SC_Instructor` FOREIGN KEY (`instructor_id`) REFERENCES `instructor` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `SC_Room` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `SC_Subject` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `SC_TraineeGroup` FOREIGN KEY (`trainee_group_id`) REFERENCES `trainee_group` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `SC_timetable` FOREIGN KEY (`timetable_id`) REFERENCES `timetable` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
